				...
				<li class="second top_bell_nav">
				   <ul class="top_dp_agile ">
									<li class="dropdown head-dpdn">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true"><i class="fa fa-plus-o" aria-hidden="true"></i> </a>
									...
									<li class="dropdown head-dpdn">
										...
										<ul class="dropdown-menu">
											<li>
											 ...
											 <li>
												<div class="notification_bottom">
													<a href="pending_Bill.html">Pending Bill</a>
												</div> 
											</li>
										</ul>
									</li>
		...
		<!-- /inner_content-->
									...
									<div class="agile-tables">
									 <form action="view_Invoice.jsp" method="post"> 
										<div class="w3l-table-info agile_info_shadow">
										 <h3 class="w3_inner_tittle two">Invoice Bill</h3>
											<table id="table">
											<thead>
											  <tr>
												<th>ID</th>
		   	...
		   	<%
				...
				try
				{
					...
					PreparedStatement ps1=con.prepareStatement("select * from invoice_tbl ");
