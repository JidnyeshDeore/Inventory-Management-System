				   ...
				   <ul class="top_dp_agile ">
									<li class="dropdown head-dpdn">
										...
										<ul class="dropdown-menu">
											<li>
												<div class="notification_header">
													<h3>Expire Raw Material</h3>
												</div>
											</li>
											 <li>
												<div class="notification_bottom">
													<a href="remove_Raw.html">Expire Raw Material</a>
												</div> 
											</li>
										</ul>
									</li>
		...
		<!-- /inner_content-->
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle">Tables</h2>
									...
									<div class="agile-tables">
									 <form action="view_Issued_Raw.jsp" method="post"> 
										<div class="w3l-table-info agile_info_shadow">
										 <h3 class="w3_inner_tittle two">Issued Raw Material</h3>
											<table id="table">
											<thead>
											  <tr>
												<th>i_id</th>
		   	...
		   	<%
				...
				try
				{
					...
					PreparedStatement ps1=con.prepareStatement("select * from issued_tbl ");
		   	...
		   	%>
		    	    	  <tr>
		    	    	    ...
		    	    	    <td><%= rs1.getString("r_name")%></td>
		    	    	     <td><%= rs1.getString("r_category")%></td>
