										...
										<ul class="dropdown-menu">
											<li>
												<div class="notification_header">
													<h3>View_Issued_stock </h3>
												</div>
											</li>
								
											 <li>
												<div class="notification_bottom">
													<a href="View_Issued_Stock.jsp">View Stock</a>
												</div> 
											</li>
										</ul>
									</li>
				   ...
				   <ul class="top_dp_agile ">
									<li class="dropdown head-dpdn">
										...
										<ul class="dropdown-menu">
											<li>
												<div class="notification_header">
													<h3>Expire Stock Material</h3>
												</div>
											</li>
											 <li>
												<div class="notification_bottom">
													<a href="remove_Stock.html">Expire Stock Material</a>
												</div> 
											</li>
										</ul>
									</li>
		...
		<!-- /inner_content-->
									...
									<div class="agile-tables">
									 <form action="view_Issued_Stock.jsp" method="post"> 
										<div class="w3l-table-info agile_info_shadow">
										 <h3 class="w3_inner_tittle two">Issued Stock</h3>
											<table id="table">
											<thead>
											  <tr>
												<th>i_id</th>
		   	...
		   	<%
				...
				try
				{
					...
					PreparedStatement ps1=con.prepareStatement("select * from issued_stock_tbl ");
		   	...
		   	%>
		    	    	  <tr>
		    	    	    ...
		    	    	    <td><%= rs1.getString("s_name")%></td>
		    	    	     <td><%= rs1.getString("s_category")%></td>
		    	    	    <td><%= rs1.getString("i_quantity")%></td>
		    	    	    <td><%= rs1.getString("issuer_name")%></td>
		    	    	    <td><%= rs1.getInt("item_id")%></td>
		    	    	     <td><%= rs1.getString("i_date")%></td>
		    	    	      <td><%= rs1.getString("i_time")%></td>
		    	    	  </tr>
		    <% 
		    		}
			   	}
		    ...
		    <br>   <br>   <br>
		  	<a href="issued_stock.html"> Back  </a> 
