...
<html lang="zxx">
<head>
<title> View Sales Manager</title>
<!-- custom-theme -->
...
<div class="wthree_agile_admin_info">
		 ...
		 <div class="wthree_agile_admin_info">
		  ...
		  <!-- /nav-->
		  	  ...
		  	  <form action="View_Sales_M.jsp" method="post"> 
									...
									<li class="dropdown head-dpdn">
										...
										<ul class="dropdown-menu">
											<li>
											 ...
											 <li>
												<div class="notification_bottom">
													<a href="remove_Sales.html">Remove Sales Manager</a>
												</div> 
											</li>
										</ul>
									</li>
				   ...
				   <ul class="top_dp_agile ">
				       <li class="dropdown head-dpdn">
										...
										<ul class="dropdown-menu">
											<li>
												<div class="notification_header">
													<h3>Specific Sales Manager</h3>
												</div>
											</li>
											<li>
												<div class="notification_bottom">
													<a href="Specific_Sales_M.jsp">Search</a>
												</div> 
											</li>
										</ul>
									</li>	
		...
		<!-- /inner_content-->
									...
									<div class="agile-tables">
									 <form action="View_Sales_M.jsp" method="post"> 
										<div class="w3l-table-info agile_info_shadow">
										 <h3 class="w3_inner_tittle two">Sales Manager</h3>
											<table id="table">
											<thead>
											  <tr>
												<th>s_id</th>
		   	...
		   	<%
				...
				try
				{
					...
					PreparedStatement ps1=con.prepareStatement("select * from sales_tbl ");
		   	...
		   	%>
		    	    	  <tr>
		    	    	    ...
		    	    	    <td><%= rs1.getString("s_mob")%></td>
		    	    	    <td><%= rs1.getInt("s_pass")%></td>
		    	    	     <td><%= rs1.getString("s_date")%></td>
		    	    	  </tr>
		    <% 
		    		}
			   	}
