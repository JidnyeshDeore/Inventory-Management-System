									...
									<li class="dropdown head-dpdn">
										...
										<ul class="dropdown-menu">
											<li>
											 ...
											 <li>
												<div class="notification_bottom">
													<a href="remove_Stock.html">Expire Stock</a>
												</div> 
											</li>
										</ul>
									</li>
		...
		<!-- /inner_content-->
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle">Tables</h2>
									...
									<div class="agile-tables">
									 <form action="view_Stock.jsp" method="post"> 
										<div class="w3l-table-info agile_info_shadow">
										 <h3 class="w3_inner_tittle two">Stock Available</h3>
											<table id="table">
											<thead>
											  <tr>
												<th>s_id</th>
		   	...
		   	<%
				...
				try
				{
					...
					PreparedStatement ps1=con.prepareStatement("select * from stock_tbl ");
		   	...
		   	%>
		    	    	  <tr>
		    	    	    ...
		    	    	    <td><%= rs1.getString("s_quantity")%></td>
		    	    	    <td><%= rs1.getString("s_bucket")%></td>
		    	    	    <td><%= rs1.getInt("s_cost_per_unit")%></td>
