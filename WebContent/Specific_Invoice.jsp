...
<html lang="zxx">
<head>
<title>Specific Invoice View</title>
<!-- custom-theme -->
...
<div class="wthree_agile_admin_info">
		 ...
		 <div class="wthree_agile_admin_info">
		  ...
		  <!-- /nav-->
		  	  ...
		  	  <form action="Specific_Invoice.jsp" method="post"> 
											...
											<li>
											 ...
											 <li>
												<div class="notification_bottom">
													<a href="invoice.html">New Invoice</a>
												</div> 
											</li>
										</ul>
									</li>
									...
									<li class="dropdown head-dpdn">
										...
										<ul class="dropdown-menu">
											<li>
											 ...
											 <li>
												<div class="notification_bottom">
													<a href="view_Invoice.jsp">Pending Bill</a>
												</div> 
											</li>
										</ul>
									</li>
				   ...
				   <ul class="top_dp_agile ">
				       <li class="dropdown head-dpdn">
										...
										<ul class="dropdown-menu">
											<li>
												<div class="notification_header">
													<h3>Search Specific Invoice</h3>
												</div>
											</li>
											<li>
												<div class="notification_bottom">
													<a href="Specific_Invoice.jsp">Search </a>
												</div> 
											</li>
										</ul>
									</li>	
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle">Search By GSTIN</h2>
										...
										<div class="signin-form profile admin">
													<h2>Specific Invoice Bill </h2>
													<div class="login-form">
														<form action="Specific_Invoice.jsp" method="post">
															
															<input type="text" name="p_gstin" placeholder="GSTIN" required="">
    ...
    %>
		   	...
		   	<%
				...
				try
				{
					...
					PreparedStatement ps1=con.prepareStatement("select * from invoice_tbl where p_gstin=?");
					ps1.setString(1, p_gstin);
		   	...
		   	%>
		    	    	  <tr>
		    	    	    ...
		    	    	    <td><%= rs1.getString("p_name")%></td>
		    	    	     <td><%= rs1.getString("p_hsn")%></td>
		    	    	      <td><%= rs1.getString("p_gstin")%></td>
		    	    	    <td><%= rs1.getString("p_quantity")%></td>
		    	    	    <td><%= rs1.getString("p_rate")%></td>
		    	    	    <td><%= rs1.getInt("p_tax_val")%></td>
		    	    	     <td><%= rs1.getString("p_gst")%></td>
		    	    	     <td><%= rs1.getString("p_total")%></td>
		    	    	     <td><%= rs1.getString("p_date")%></td>
		    	    	  </tr>
