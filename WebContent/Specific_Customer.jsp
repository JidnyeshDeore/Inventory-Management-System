...
<html lang="zxx">
<head>
<title>Specific Customer View</title>
<!-- custom-theme -->
...
<div class="wthree_agile_admin_info">
		 ...
		 <div class="wthree_agile_admin_info">
		  ...
		  <!-- /nav-->
		  	  ...
		  	  <form action="Specific_Customer.jsp" method="post"> 
									...
									<li class="dropdown head-dpdn">
										...
										<ul class="dropdown-menu">
											<li>
											 ...
											 <li>
												<div class="notification_bottom">
													<a href="view_Customer.jsp">view all Customer</a>
												</div> 
											</li>
										</ul>
									</li>
				   ...
				   <ul class="top_dp_agile ">
				       <li class="dropdown head-dpdn">
										...
										<ul class="dropdown-menu">
											<li>
												<div class="notification_header">
													<h3>Search Specific Customer</h3>
												</div>
											</li>
											<li>
												<div class="notification_bottom">
													<a href="Specific_Customer.jsp">Search </a>
												</div> 
											</li>
										</ul>
									</li>	
		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<!-- breadcrumbs -->
						<div class="w3l_agileits_breadcrumbs">
							<div class="w3l_agileits_breadcrumbs_inner">
								<ul>
									<li><a href="customer.html">back</a><span>«</span></li>
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle">Search By:</h2>
									
										<div class="signin-form profile admin">
													<h2>Specific Customer </h2>
													<div class="login-form">
														<form action="Specific_Customer.jsp" method="post">
															
															<input type="text" name="c_id" placeholder="Customer Id" required="">
													 ...
													 <h6><a href="customer.html">Back </a><h6>
    ...
    %>
		   	...
		   	<%
				...
				try
				{
					...
					PreparedStatement ps1=con.prepareStatement("select * from customer_tbl where c_id=? and c_email=?");
		   	...
		   	%>
		    	    	  <tr>
		    	    	     <td><%= rs1.getInt("c_id")%></td>
		    	    	     <td><%= rs1.getString("c_name")%></td>
		    	    	     <td><%= rs1.getString("c_email")%></td>
		    	    	     <td><%= rs1.getString("c_mob")%></td>
		    	    	     <td><%= rs1.getString("c_buy_prod")%></td>
		    	    	     <td><%= rs1.getString("c_quantity")%></td>
